...
const formSchema = z.object({
  ...
  medicalConditions: z.string().min(1, { message: "Please describe your medical conditions or enter 'None'" }),
  hobbies: z.string().min(1, { message: "Please tell us about your hobbies or enter 'None'" }),
});

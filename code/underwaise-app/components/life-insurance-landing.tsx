...
export function LifeInsuranceLanding() {
  return (
    <div className="min-h-screen bg-[#3b3a53]">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="max-w-2xl">
              ...
              <p className="text-xl text-white/80 mb-8 leading-relaxed">
                Comprehensive life insurance that safeguards your family's
                financial future. Death and disability coverage with
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#3b3a53]/5 rounded-full mb-6 border border-[#3b3a53]/10">
              <span className="text-sm font-semibold text-[#3b3a53]">
                Coverage Details
              </span>
            </div>
            ...
            <p className="text-lg text-[#3b3a53]/70 max-w-2xl mx-auto">
              Financial protection when your family needs it most. Simple
              coverage that ensures peace of mind.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="group bg-gradient-to-br from-white to-zinc-50/50 hover:from-zinc-50 hover:to-white rounded-3xl p-8 border border-[#3b3a53]/10 hover:border-[#7cb50d]/50 transition-all hover:shadow-2xl">
              ...
              <p className="text-[#3b3a53]/70 leading-relaxed mb-6">
                Tax-free payout to your beneficiaries to cover funeral costs,
                outstanding debts, mortgages, and ongoing living expenses.
              </p>
            ...
            <div className="group bg-gradient-to-br from-white to-zinc-50/50 hover:from-zinc-50 hover:to-white rounded-3xl p-8 border border-[#3b3a53]/10 hover:border-[#7cb50d]/50 transition-all hover:shadow-2xl">
              ...
              <p className="text-[#3b3a53]/70 leading-relaxed mb-6">
                Income replacement if you become disabled and unable to work.
                Your family maintains financial stability during recovery.
              </p>
              <ul className="space-y-3">
                <li className="flex items-start gap-2 text-sm text-[#3b3a53]/80">
                  <CheckCircle2 className="h-5 w-5 text-[#7cb50d] flex-shrink-0 mt-0.5" />
            ...
            <div className="group bg-gradient-to-br from-white to-zinc-50/50 hover:from-zinc-50 hover:to-white rounded-3xl p-8 border border-[#3b3a53]/10 hover:border-[#7cb50d]/50 transition-all hover:shadow-2xl">
              ...
              <p className="text-[#3b3a53]/70 leading-relaxed mb-6">
                Your family maintains their lifestyle, pays for education, and
                handles daily expenses without financial burden.
              </p>
              <ul className="space-y-3">
                <li className="flex items-start gap-2 text-sm text-[#3b3a53]/80">
                  <CheckCircle2 className="h-5 w-5 text-[#7cb50d] flex-shrink-0 mt-0.5" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-[#3b3a53] mb-6 tracking-tight">
                Switzerland's Most{" "}
                <span className="text-[#7cb50d]">Trusted</span> Life Insurance
              </h2>
              <p className="text-lg text-[#3b3a53]/70 mb-10">
                Founded in 1876, PAX is a member-owned cooperative that puts
                policyholders first. Nearly 150 years of protecting Swiss
                families with unmatched financial strength.
              </p>

              <div className="space-y-5">
                {[
                  {
                    text: "5-minute online application",
                    detail: "Simple, fast, no paperwork",
                  },
                  {
                    text: "Coverage up to CHF 400,000+",
                    detail: "Flexible amounts for your needs",
                  },
                  {
                    text: "Member-owned cooperative",
                    detail: "Profits returned to members, not shareholders",
                  },
                  {
                    text: "223% financial strength rating",
                    detail: "Exceptional stability and security",
                  },
                  {
                    text: "100% transparent pricing",
                    detail: "No hidden fees or surprise charges",
                  },
                  {
                    text: "Comprehensive support",
                    detail: "Death and disability coverage included",
                  },
                ].map((benefit, index) => (
                ...
                <div className="space-y-5">
                  <div className="bg-white rounded-2xl p-6 shadow-sm border-l-4 border-[#7cb50d] hover:shadow-lg transition-shadow">
                    ...
                    <div className="text-sm text-[#3b3a53]/70">
                      Tax-free payout covering mortgage, debts, and living
                  ...
                  <div className="bg-white rounded-2xl p-6 shadow-sm border-l-4 border-[#3b3a53]/30 hover:shadow-lg transition-shadow">
                    ...
                    <div className="text-sm text-[#3b3a53]/70">
                      Monthly payments if unable to work, covering medical bills
                      and daily expenses
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-2xl p-6 shadow-sm border-l-4 border-[#3b3a53]/20 hover:shadow-lg transition-shadow">
                    ...
                    <div className="text-sm text-[#3b3a53]/70">
                      No financial burden during difficult times—your family
                      stays secure
                    </div>
                  </div>
                </div>
      ...
      <section
        id="about"
        className="relative overflow-hidden bg-gradient-to-br from-[#3b3a53] via-[#4a495e] to-[#3b3a53] py-24"
      >
        {/* Animated background */}
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="bg-white rounded-3xl p-12 md:p-16 shadow-2xl">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-xl text-[#3b3a53]/70 mb-10 leading-relaxed">
                Join thousands of Swiss families who trust PAX for their life
                insurance needs. Simple application, transparent pricing, and
                150 years of financial strength.
              </p>
              ...
              <div className="grid grid-cols-3 gap-8 pt-8 border-t border-[#3b3a53]/10">
                <div>
                  <div className="text-3xl font-bold text-[#3b3a53] mb-1">
                    5 min
                  </div>
                  <div className="text-sm text-[#3b3a53]/70">
                    Application time
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-white/70 text-sm leading-relaxed max-w-sm">
                ...
                Member-owned, financially strong, and dedicated to protecting
                families.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a
                    href="#coverage"
                    className="text-white/70 hover:text-[#7cb50d] text-sm transition-colors"
                  >
                    Coverage
                  </a>
                </li>
          ...
          <div className="pt-8 border-t border-white/10">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-white/60 text-sm text-center md:text-left">
                © {new Date().getFullYear()} PAX Schweizerische
                Lebensversicherungs-Gesellschaft AG. All rights reserved.
              </p>
              <div className="flex gap-6 text-xs text-white/60">
                <a href="#" className="hover:text-[#7cb50d] transition-colors">
                  Privacy Policy
                </a>
                <a href="#" className="hover:text-[#7cb50d] transition-colors">
                  Terms of Service
